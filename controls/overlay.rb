include_controls 'microsoft-windows-server-2016-stig-baseline' do
  ...
  control 'V-73259' do
    ...
    This will return accounts that have not been logged on to for 90 days, along
    ...
    If any enabled accounts have not been logged on to within the past 90 days,
    this is a finding.
    ...
    Remove or disable accounts that have not been used in the last 90 days."
  end
  control 'V-73265' do
    impact 0
  ...
  control 'V-73311' do
    title "Windows Server 2016 must have the number of allowed bad logon attempts
    configured to five or less."
    ...
    If the \"Account lockout threshold\" is \"0\" or more than \"5\" attempts, this
    is a finding.
    ...
    If \"LockoutBadCount\" equals \"0\" or is greater than \"5\" in the file, this
    is a finding."
    desc "fix", "Configure the policy value for Computer Configuration >> Windows
    Settings >> Security Settings >> Account Policies >> Account Lockout Policy >>
    \"Account lockout threshold\" to \"5\" or fewer invalid logon attempts
